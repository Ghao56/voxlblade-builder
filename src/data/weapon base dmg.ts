import type { WeaponBaseDmg } from '../lib/types';
  ...
  export const WEAPON_BASE_DMG: WeaponBaseDmg[] = [
    ...
    { type: 'Cosmic Ray',           m1: null, noM1: true,                 m2: [18.5] },
    { type: 'Mine',                 m1: null, noM1: true,                 m2: [5, 10, 15] },
    { type: 'Side Gun',             m1: null, noM1: true,                 m2: [7] },
    { type: 'Shotgun',              m1: null, noM1: true,                 m2: [{n:4.5,count:3}] },
