...
import {
  ...
  WEAKENING_ROAR_WEAKNESS_POTENCY, WEAKENING_ROAR_WEAKNESS_DURATION,
  MOD_IRON_SLAYER_POTENCY, MOD_IRON_SLAYER_DURATION,
  MOD_FURY_POTENCY, MOD_FURY_DURATION, MOD_VOID_RAGE_DURATION, MOD_TAILWIND_POTENCY, MOD_WIND_WALKER_DURATION_DIVISOR, MOD_SLOW_LEAK_DURATION,
  ...
  GLACIAL_SHELL_SHIELD_POTENCY,
  GLACIAL_SHELL_DURATION,
  GLACIAL_SHELL_RECOVERY_PCT,
...
export const BUFF_DEFS: Record<string, BuffDefinition> = {
  ...
  'Drone Armor': {
    name: 'Drone Armor',
    color: '#f59e0b',
    description: 'Increase shield max by x',
  ...
  'Ice Shell': {
    name: 'Ice Shell',
    color: '#00e6ff',
    description: 'Increase shield max by 50, boost shield recovery rate by 30% and grant immunity to slowing effects for 20s.',
    effectPerTenthPotency: BUFF_EFFECT_PER_TENTH,
    effectUnit: 'flat',
    statKey: 'shield',
    isNeutral: true,
  ...
  'Electro Shield': {
    name: 'Electro Shield',
    color: '#38bdf8',
    description: 'Autoparry anything that hits you and shock them in retaliation. Consumed when hit.',
    effectPerTenthPotency: BUFF_EFFECT_PER_TENTH,
    effectUnit: 'flat',
    isNeutral: true,
  },
...
const ITEM_BUFF_MAP: GrantedBuff[] = [
  ...
  {
    buffName: 'Ice Shell',
    potency: GLACIAL_SHELL_SHIELD_POTENCY,
    duration: GLACIAL_SHELL_DURATION,
    condition: 'On cast',
    sourceName: 'Glacial Shell Rune',
    sourceType: 'rune',
  },
  {
    buffName: 'Taunt',
  ...
  {
    buffName: 'Weakness',
    potency: WEAKENING_ROAR_WEAKNESS_POTENCY,
    duration: WEAKENING_ROAR_WEAKNESS_DURATION,
    condition: 'On cast',
    sourceName: 'Weakening Roar Rune',
    sourceType: 'rune',
  },
  {
    buffName: 'Electro Shield',
    potency: ELECTRO_SHIELD_POTENCY,
    duration: ELECTRO_SHIELD_DURATION,
    condition: `Constantly applies to the user · stacks up to ${ELECTRO_SHIELD_MAX_STACKS} · also applies to allies`,
...
const PERK_BUFFS: Record<string, PerkBuffFactory> = {
  ...
  'Queens Power': (amount) => [
    ...
    {
      buffName: 'Reinforce',
      potency: SWIFT_GUARD_POTENCY_PER_AMOUNT * amount,
      duration: SWIFT_GUARD_DURATION,
      condition: 'on Dodge',
      sourceName: 'Swift Guard',
      sourceType: 'perk',
    },
  ],
      'Runic Winds': (amount) => [
    {
      buffName: 'Tailwind',
      potency: RUNIC_WINDS_POTENCY_PER_AMOUNT * amount,
      duration: RUNIC_WINDS_DURATION,
      condition: 'on Rune activation',
      sourceName: 'Runic Winds',
      sourceType: 'perk',
    },
  ],
      'Croakernaut Spirit': () => [
  ...
  'Ichor Spark': (amount) => [
    ...
    'Grandmagic Guard': (amount) => [
    {
      buffName: 'Magic Reinforce',
      potency: GRANDMAGIC_GUARD_POTENCY_PER_AMOUNT * amount,
...
const BUFF_POTENCY_MODIFIERS: BuffPotencyModifier[] = [
  ...
  { buffName: 'Rage', potencyPerStack: MOD_FURY_POTENCY, label: 'Fury', durationMultiplierPerStack: MOD_FURY_DURATION },
  { buffName: 'Rage', potencyPerStack: 0,   label: 'Void Rage', durationMultiplierPerStack: MOD_VOID_RAGE_DURATION },
