...
export const EXPLOSIVE_HONEY_MULT_PER_STACK = 0.10
...
export const JUGGERNAUT_DMG_MULT_PER_NEGATIVE_PCT = 0.75
export const JUGGERNAUT_KNOCKBACK_RESIST_PER_NEGATIVE_PCT = 0.2
export const RIDER_MULT_PER_STACK = 0.20
export const QUICKDRAW_MULT = 3
export const SPRING_POWERED_MULT = 0.01
