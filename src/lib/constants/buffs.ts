...
export const BOUNCE_RUNE_DURATION = 12
...
export const SANGUINE_BOLT_BLEED_DURATION = 5
...
export const JAVELIN_BLEED_DURATION = 6
...
export const CROSS_SLASH_SHATTER_POTENCY = 0.2
export const CROSS_SLASH_SHATTER_DURATION = 8
export const DAGGER_THROW_POISON_DURATION = 5
export const SHATTER_SHATTER_POTENCY = 0.3
export const SHATTER_SHATTER_DURATION = 10
export const FLAME_SLASH_BURN_DURATION = 5
export const ICICLE_WAVE_FROSTBITE_DURATION = 12

// True Balance conversions
const TRUE_BALANCE_POTENCY_COEFF = 0.1
const TRUE_BALANCE_REGEN_DURATION_BASE = 1
const TRUE_BALANCE_TAILWIND_DURATION_BASE = 3
const TRUE_BALANCE_REINFORCE_POTENCY_BASE = 0.1
const TRUE_BALANCE_RAGE_DURATION_BASE = 3
...
export const JETSTREAM_RUNE_BUFF_POTENCY = 0.1
export const JETSTREAM_RUNE_BUFF_DURATION = 5
export const JETSTREAM_RUNE_SLOWNESS_POTENCY = 0.5
export const JETSTREAM_RUNE_SLOWNESS_DURATION = 5
...
export const ICESTORM_POTENCY_PER_AMOUNT = 0.25
export const ICESTORM_DURATION = 10
export const SWIFT_GUARD_POTENCY_PER_AMOUNT = 0.2
export const SWIFT_GUARD_DURATION = 10
...
export const SHATTERING_JUSTICE_POTENCY_PER_AMOUNT = 0.2
export const SHATTERING_JUSTICE_DURATION = 7
export const SERRATED_EDGE_DURATION = 5
...
export const THORNS_BLEED_DURATION = 5
export const STICKY_SWINGS_POTENCY_PER_AMOUNT = 0.5
export const STICKY_SWINGS_DURATION = 10
...
export const SLAYER_RAGE_RAGE_RUNE_WEAK_POTENCY = 0.2
export const SLAYER_RAGE_WEAK_DURATION = 5
export const SLAYER_RAGE_ROAR_WEAK_BASE_POTENCY = 0.5
export const SLAYER_RAGE_ROAR_RAGE_POTENCY = 0.2
export const SLAYER_RAGE_ROAR_RAGE_DURATION = 10
export const WEAKENING_ROAR_WEAKNESS_POTENCY = 0.5
export const WEAKENING_ROAR_WEAKNESS_DURATION = 15
export const MOD_IRON_SLAYER_POTENCY = 0.2
export const MOD_IRON_SLAYER_DURATION = 2
export const MOD_FURY_POTENCY = 0.1
export const MOD_FURY_DURATION = 1.2
export const MOD_VOID_RAGE_DURATION = 1.2
...
export const MOD_VAPOR_AEGIS_REINFORCE_DURATION = 1.1
...
// Propelling Fun
export const PROPELLING_FUN_POTENCY_PER_AMOUNT = 0.1
export const PROPELLING_FUN_DURATION_MULTIPLIER = 5
export const CLOUDPUSH_PCT_PER_POTENCY = 7.5
