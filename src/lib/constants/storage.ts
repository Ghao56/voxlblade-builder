...
export const BUILD_STATE_DEFAULTS: Record<string, any> = {
  ...
  level: DEFAULT_LEVEL, hpFill: DEFAULT_HP_FILL, enemyHpFill: DEFAULT_ENEMY_HP_FILL, summonCount: 0, buffsConsumed: 0, sporelingsSummoned: 0,   bastionBallistaArrows: 0, ichorSparkCharge: 100, divineCrashDistance: 250,
...
export const SAVE_KEY_MAP: Record<string, string> = {
  ...
  bastionBallistaArrows:'bba', ichorSparkCharge:'isc', divineCrashDistance:'dcd',
