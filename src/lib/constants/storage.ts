...
export const BUILD_STATE_DEFAULTS: Record<string, any> = {
  ...
  level: DEFAULT_LEVEL, hpFill: DEFAULT_HP_FILL, enemyHpFill: DEFAULT_ENEMY_HP_FILL, inventoryFill: DEFAULT_INVENTORY_FILL, summonCount: 0, vassalsCroakSummons: undefined, lastCroakStacks: undefined, buffsConsumed: 0, sporelingsSummoned: 0, enchantedSwordType: 0, bastionBallistaArrows: 0, ichorSparkCharge: 100, divineCrashDistance: 250, channeledDepthsTime: 0, channeledDepthsTarget: 'WA', channeledDepthsHit: 1, voidContractTarget: 'M1', voidContractHit: 1, deathmistHit: 1,
  ...
  disableWeaponBoost: false, mycoticBloomDotDisabled: false, showCritValues: false, healCritEnabled: true,
...
export const SAVE_KEY_MAP: Record<string, string> = {
  ...
  channeledDepthsTime:'cdt', channeledDepthsTarget:'cdtg', channeledDepthsHit:'cdth', voidContractTarget:'vctg', voidContractHit:'vcth', deathmistHit:'dmh',
  ...
  disableWeaponBoost:'dwb', mycoticBloomDotDisabled:'mbd', showCritValues:'scv', healCritEnabled:'hce',
